...
bool LineCollider::checkCollision(const CircleCollider * other) const {
	// Por las propiedades del círculo, solo comprueba en el segmento que contiene la X del centro del c�rculo
	...
	if (!found) {	// Está más a la derecha que el �ltimo punto, comprueba la colision con el último segmento
